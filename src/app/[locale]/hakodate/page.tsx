    ...
    <main className="min-h-screen">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-8">Hakodate Features</h2>
                ...
                <Card className="overflow-hidden border-0 shadow-lg">
                  <div className="relative h-48">
                    ...
                    <div className="absolute bottom-2 left-2 bg-white/90 px-2 py-1 rounded text-xs font-medium">
                      {index === 0 && 'Hakodate Wedding Kimono'}
                      {index === 1 && 'Hakodate Proposal'}
                      {index === 2 && 'Hakodate Couple'}
                      {index === 3 && 'Hakodate Couple 2'}
                      {index === 4 && 'Hakodate Couple 3'}
                      {index === 5 && 'Hakodate Family'}
                    </div>
                  </div>
                </Card>
              </motion.div>
