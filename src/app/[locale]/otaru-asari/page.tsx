    ...
    <main className="min-h-screen">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-8">Otaru & Asari Features</h2>
                ...
                <Card className="overflow-hidden border-0 shadow-lg">
                  <div className="relative h-48">
                    ...
                    <div className="absolute bottom-2 left-2 bg-white/90 px-2 py-1 rounded text-xs font-medium">
                      {index === 0 && 'Otaru Wedding'}
                      {index === 1 && 'Otaru Autumn'}
                      {index === 2 && 'Historic Photo'}
                      {index === 3 && 'Scenic Photo'}
                      {index === 4 && 'Shikotsu Lake Winter'}
                      {index === 5 && 'Biei Early Summer'}
                    </div>
                  </div>
                </Card>
              </motion.div>
