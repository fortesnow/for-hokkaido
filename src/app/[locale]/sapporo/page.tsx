...
export default function SapporoPage() {
  // ヒーロー画像
  const heroImage = '/images/sapporo_night_view_winter.webp';

  // ギャラリー画像とロケーション情報
  const galleryData = [
    { image: '/images/sapporo_wedding_summer.webp', location: 'Sapporo Station Area', caption: '札幌駅周辺の現代的な街並み' },
    { image: '/images/sapporo_wedding_summer_1.webp', location: 'Odori Park', caption: '大通公園でのナチュラル撮影' },
    { image: '/images/sapporo_night_view_winter.webp', location: 'Mt. Moiwa', caption: '藻岩山の夜景スポット' },
    { image: '/images/sapporo_night_view_winter_2.webp', location: 'Sapporo Clock Tower', caption: '札幌時計台周辺' },
    { image: '/images/sapporo_snow_wedding.webp', location: 'Jozankei Onsen', caption: '定山渓温泉の雪景色' },
    { image: '/images/ryo_0049.webp', location: 'Hokkaido Shrine', caption: '北海道神宮の厳かな雰囲気' },
  ];
  ...
  // 都市の特徴
  const features = [
    'Urban photography with modern architecture and city landscapes',
    'Natural beauty and stunning landscapes for perfect photo opportunities'
  ];
    ...
    <main className="min-h-screen">
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white">
          ...
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6">Sapporo</h1>
            <div className="flex items-center justify-center gap-2 text-lg mb-8">
              <MapPin className="h-5 w-5" />
              <span>北海道の中央に位置する道庁所在地</span>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-8">札幌の魅力</h2>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">札幌で撮影できる様々なロケーションをご紹介</p>
          </motion.div>
