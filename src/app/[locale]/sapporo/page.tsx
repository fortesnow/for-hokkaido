...
export default function SapporoPage() {
  ...
  const galleryImages = [
    ...
    '/images/sapporo_wedding_summer_1.webp',
    '/images/sapporo_night_view_winter.webp',
    '/images/sapporo_night_view_winter_2.webp',
    ...
    <main className="min-h-screen">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-8">Sapporo Features</h2>
                ...
                <Card className="overflow-hidden border-0 shadow-lg">
                  <div className="relative h-48">
                    ...
                    <div className="absolute bottom-2 left-2 bg-white/90 px-2 py-1 rounded text-xs font-medium">
                      {index === 0 && 'Sapporo Wedding Summer'}
                      {index === 1 && 'Sapporo Wedding Summer 1'}
                      {index === 2 && 'Sapporo Night View Winter'}
                      {index === 3 && 'Sapporo Night View Winter 2'}
                      {index === 4 && 'Sapporo Snow Wedding'}
                      {index === 5 && 'Sapporo Photo'}
                    </div>
                  </div>
                </Card>
              </motion.div>
